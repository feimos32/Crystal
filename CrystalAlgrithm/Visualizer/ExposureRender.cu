...
__global__ void ExposureRender_visualize_core(FrameBuffer* fb_GPU);
void ExposureRender::visualize() {
	...
	dim3    threads(16, 16);
	ExposureRender_visualize_core << <blocks, threads >> > (framebuffer_GPU);
