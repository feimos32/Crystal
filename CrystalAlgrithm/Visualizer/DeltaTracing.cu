...
__global__ void DeltaTracing_visualize_core(FrameBuffer* fb_GPU);
void DeltaTracing::visualize() {
	...
	dim3    threads(16, 16);
	DeltaTracing_visualize_core << <blocks, threads >> > (framebuffer_GPU);
