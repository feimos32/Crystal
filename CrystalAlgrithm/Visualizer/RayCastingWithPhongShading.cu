...
__global__ void RayCastingWithPhongShading_visualize_core(FrameBuffer* fb_GPU);
void RayCastingWithPhongShading::visualize() {
	...
	dim3    threads(16, 16);
	RayCastingWithPhongShading_visualize_core << <blocks, threads >> > (framebuffer_GPU);
